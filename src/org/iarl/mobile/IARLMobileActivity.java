...
public class IARLMobileActivity extends TabActivity {
	...
	private Set<String> setting_bands;
	private int setting_region = 0;
	private int setting_update_position = 5; // Update every 5km
	private int setting_update_time = 5;	 // Update every 5mins
